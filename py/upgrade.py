...
# Requiert un fichier ecopartpatch.zip contenant l'arboresence complete depuis la racine de l'application (ce repertoire)
...
if not os.path.exists("ecopartpatch.zip"):
    print("File ecopartpatch.zip must be in the current directory")
    exit()
...
print("Open ZipFile")
zfile=ZipFile("ecopartpatch.zip" , 'r',allowZip64 = True)
