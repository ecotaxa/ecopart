...
from to_back.ecotaxa_cli_py.api.acquisitions_api import AcquisitionsApi  # noqa: E501
...
class TestAcquisitionsApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = to_back.ecotaxa_cli_py.api.acquisitions_api.AcquisitionsApi()  # noqa: E501
