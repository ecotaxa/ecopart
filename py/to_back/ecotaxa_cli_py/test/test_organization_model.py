...
from to_back.ecotaxa_cli_py.models.organization_model import OrganizationModel  # noqa: E501
...
class TestOrganizationModel(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = to_back.ecotaxa_cli_py.models.organization_model.OrganizationModel()  # noqa: E501
        if include_optional :
            return OrganizationModel(
                id = 1, 
                name = 'OrganizationName', 
                directories = 'edmo:1278'
            )
        else :
            return OrganizationModel(
                id = 1,
