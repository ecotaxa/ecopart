...
from to_back.ecotaxa_cli_py.models.user_model_with_rights import UserModelWithRights  # noqa: E501
...
class TestUserModelWithRights(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = to_back.ecotaxa_cli_py.models.user_model_with_rights.UserModelWithRights()  # noqa: E501
        if include_optional :
            return UserModelWithRights(
                ...
                status_admin_comment = '0', 
                usercreationreason = 'Analysis of size and shapes of plastic particles', 
                mail_status = True, 
                mail_status_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
