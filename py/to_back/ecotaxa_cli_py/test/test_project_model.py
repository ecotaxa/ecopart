...
from to_back.ecotaxa_cli_py.models.project_model import ProjectModel  # noqa: E501
...
class TestProjectModel(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = to_back.ecotaxa_cli_py.models.project_model.ProjectModel()  # noqa: E501
        if include_optional :
            return ProjectModel(
                projid = 4824, 
                title = 'MyProject', 
...
feret = Feret [pixel]', 
                ...
                bodc_variables = {"subsample_coef":"1/ssm.sub_part","total_water_volume":"sam.tot_vol/1000","individual_volume":"4.0/3.0*math.pi*(math.sqrt(obj.area/math.pi)*ssm.pixel_size)**3"}, 
