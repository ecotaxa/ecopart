    ...
    def make_instance(self, include_optional):
        ...
        if include_optional :
            return Constants(
                ...
                access = {"PUBLIC":"","OPEN":"O","PRIVATE":"P"}, 
                app_manager = ["App manager Name","app.manager@email.fr"], 
                countries = ["France"], 
                people_organization_directories = {"https://edmo.seadatanet.org/":"edmo","https://orcid.org/":"orcid"}, 
                user_status = {"blocked":-1,"inactive":0,"active":1,"pending":2}, 
                user_type = {"guest":"guest"}, 
                password_regexp = '^(?:(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#?%^&*-+])).{8,20}$', 
                email_verification = True, 
                account_validation = True, 
                short_token_age = 56, 
                profile_token_age = 56, 
                recaptchaid = True, 
