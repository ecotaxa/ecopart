...
from to_back.ecotaxa_cli_py.models.taxonomy_tree_status import TaxonomyTreeStatus  # noqa: E501
...
class TestTaxonomyTreeStatus(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = to_back.ecotaxa_cli_py.models.taxonomy_tree_status.TaxonomyTreeStatus()  # noqa: E501
        if include_optional :
            return TaxonomyTreeStatus(
                last_refresh = '2021-10-07T01:26:47'
            )
        else :
            return TaxonomyTreeStatus(
        )
